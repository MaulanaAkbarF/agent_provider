  ...
  Widget _latLongInfo(BuildContext context, LocationProvider provider, bool isSattelite){
    return Positioned(top: paddingNear, left: 0, right: 0,
      child: Row(
        ...
        children: [
          cText(context, provider.geocodingModel.latitude.toString(), style: TextStyles.small(context).copyWith(color: isSattelite ? Colors.white : Colors.black, fontWeight: FontWeight.bold)),
          RowDivider(),
          cText(context, provider.geocodingModel.longitude.toString(), style: TextStyles.small(context).copyWith(color: isSattelite ? Colors.white : Colors.black, fontWeight: FontWeight.bold))
        ],
      ),
    );
  }
                ...
                Row(
                  children: [
                    ...
                    Expanded(child: GestureDetector(onTap: () => showSearchLocation(context, provider), child: Container(color: Colors.transparent,
                      child: cText(context, provider.mapSearchTechnology.text, maxLines: 1, align: TextAlign.right,
