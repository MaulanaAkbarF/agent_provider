...
Widget labelRequired(BuildContext context, String title, {bool? showRequired, TextStyle? style}){
  return Align(
    ...
    child: RichText(
      ...
      text: TextSpan(
        children: <InlineSpan>[
          TextSpan(text: title, style: style ?? TextStyles.medium(context).copyWith(color: ThemeColors.surface(context), fontWeight: FontWeight.bold)),
          const WidgetSpan(child: SizedBox(width: 3)),
          if ((showRequired != null) && showRequired) TextSpan(text: '*', style: TextStyles.medium(context).copyWith(color: ThemeColors.red(context))),
        ],
      ),
    ),
  );
