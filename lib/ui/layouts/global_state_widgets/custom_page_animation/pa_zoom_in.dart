...
class _PageAnimationZoomInState extends State<PageAnimationZoomIn> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Consumer<PreferenceSettingProvider>(
      builder: (context, provider, child) {
      if (!provider.useAnimation.condition || provider.useAnimation.condition && !provider.pageAnimation.condition) return widget.child;
