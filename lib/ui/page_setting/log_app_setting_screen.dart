...
import '../../core/models/_settings_model/log_app.dart';
...
import '../layouts/global_state_widgets/dialog/dialog_action/loading_upload.dart';
...
class LogAppSettingScreen extends StatelessWidget {
  ...
  AppBar _appBar(BuildContext context){
    return appBarWidget(context: context, title: 'Log Aplikasi', showBackButton: true,
  ...
  Widget _listItemBuilder(BuildContext context, LogAppCollection data){
    ...
    if (data.level != null){
      if (data.level!.contains(ListLogAppLevel.critical.level)) {
        warningColor = ThemeColors.red(context);
