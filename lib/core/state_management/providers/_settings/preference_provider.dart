...
class PreferenceSettingProvider extends ChangeNotifier{
  ...
  Future<void> setLanguage(String data) async {
    try{
      if (data.contains(ListLanguage.indonesia.text)) {
        _language = ListLanguage.indonesia;
      } else {
        _language = ListLanguage.indonesia;
      }
    } catch (e, s) {
  ...
  Future<void> setTimeZone(String data) async {
    try{
      if (data.contains(ListTimeZone.jakartaWib.text)) {
        _timeZone = ListTimeZone.jakartaWib;
  ...
  Future<void> setDateFormat(String data) async {
    try{
      if (data.contains(ListDateFormat.dayMonthYear.text)) {
        _dateFormat = ListDateFormat.dayMonthYear;
  ...
  Future<void> setTimeFormat(String data) async {
    try{
      if (data.contains(ListTimeFormat.hourMinute.text)) {
        _timeFormat = ListTimeFormat.hourMinute;
