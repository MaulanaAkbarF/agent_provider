...
import 'package:agent/core/state_management/providers/_settings/permission_provider.dart';
import 'package:agent/core/state_management/providers/_settings/preference_provider.dart';
import 'package:agent/core/state_management/providers/auth/user_provider.dart';
...
class AppearanceSettingProvider extends ChangeNotifier{
  ...
  Future<void> setFontSize(String data, {bool? notify}) async {
    try {
      if (data.contains(ListFontSize.verySmall.text)) {
        _fontSize = ListFontSize.verySmall;
