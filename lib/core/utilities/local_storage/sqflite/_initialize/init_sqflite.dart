...
class SqfliteDatabaseHelper {
  ...
  static Future<Database> initializeSqflite() async {
    clog('INITIALIZE SQFLITE STARTED');
    try {
      ...
      GlobalData.sqfliteFailedMessage = 'Terjadi masalah saat mengisiasi SQFLite DB: $e';
      clog('Terjadi masalah saat mengisiasi SQFLite DB: $e\n$s');
      rethrow;
    }
  }
